...
* 
* File: src/gsn/storage/db/MemcacheStorageManager.java
*
...
public class MemcacheStorageManager extends StorageManager {

    private static final transient Logger logger = Logger.getLogger(MemcacheStorageManager.class);

    public MemcacheStorageManager() {
        super();
    }
